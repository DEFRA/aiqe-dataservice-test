...
(Visual only)`
  ...
  it('AQD-1239 - tab content for UKEAP: Precip-Net Network', async () => {
    await browser.url('')
    await browser.maximizeWindow()
    await startNowPage.startNowBtnClick()
    await hubPage.getCreateCustomDataSet.click()
    ...
    await customselectionPage.getAddPollutantLink.click()
    await addPollutantPage.getAddPollutantOption.click()
    await addPollutantPage.addPollutant('Calcium in precipitation')
    await common.continueButton.click()
    await customselectionPage.getAddChangeLocationLink.click()
    await addLocationPage.getCountriesOption.click()
    await addLocationPage.getEnglandCheckbox.click()
...
(Visual only)`
  ...
  it('AQD-1239 - download checks for UKEAP: Precip-Net Network', async () => {
    await browser.url('')
    await browser.maximizeWindow()
    await startNowPage.startNowBtnClick()
    await hubPage.getCreateCustomDataSet.click()
    ...
    // Download : UKEAP - Precip-Net
    await DownloadYourDataPage.getDownloadUKEAPPrecipNetworkButton.click()
    ...
    await browser.waitUntil(
      ...
      },
      {
        timeout: 240000,
        interval: 500,
        timeoutMsg: 'UKEAP Precip-Net download not detected within 240s'
      }
    )
...
(Visual only)`
  ...
  it('AQD-1427 - tab content for PAH Andersen Network', async () => {
    await browser.url('')
    await browser.maximizeWindow()
    await startNowPage.startNowBtnClick()
    await hubPage.getCreateCustomDataSet.click()
...
UKEAP - Acid Gas & Aerosol Network
Monitors atmospheric pollutants. Part of the UK Eutrophying and Acidifying Atmospheric Pollutants (UKEAP) Network that monitors long-term pollutant trends in rural and remote locations.
14 stations available
Download data
(Visual only)
UKEAP - Precip-Net
Monitors the chemical composition of pollution in rainwater. Part of the UK Eutrophying and Acidifying Atmospheric Pollutants (UKEAP) Network that monitors long-term pollutant trends in rural and remote locations.
17 stations available
Download data
(Visual only)
PAH Andersen
...
No data available for the selected range.`
  ...
  it('AQD-1427 - download checks for PAH Andersen Network', async () => {
    await browser.url('')
    await browser.maximizeWindow()
    await startNowPage.startNowBtnClick()
    await hubPage.getCreateCustomDataSet.click()
    ...
    // Download : Dibenzo(ah)anthracene (DBAhA)
    await DownloadYourDataPage.getDownloadPAHAndersenNetworkMonitoringNetworkButton.click()
    ...
    await browser.waitUntil(
      ...
      },
      {
        timeout: 240000,
        interval: 500,
        timeoutMsg: 'PAH Andersen Network download not detected within 240s'
      }
    )
    ...
    // Verify downloaded file contains pollutant values (and includes DBAhA)
    const parseCsvLine = (line) => {
      const cells = []
      let current = ''
      let inQuotes = false
    ...
    for (const csvPath of csvPaths) {
      ...
      if (
        pollutantValues.some((value) =>
          value.toLowerCase().includes('dibenzo(ah)anthracene')
        )
      ) {
  ...
  it('AQD-1427 - tab content for PAH Deposition Network', async () => {
    await browser.url('')
    await browser.maximizeWindow()
    await startNowPage.startNowBtnClick()
    await hubPage.getCreateCustomDataSet.click()
...
(Visual only)`
  ...
  it('AQD-1427 - download checks for PAH Deposition Network', async () => {
    await browser.url('')
    await browser.maximizeWindow()
    await startNowPage.startNowBtnClick()
    await hubPage.getCreateCustomDataSet.click()
    ...
    // Download : Benzo(a)pyrene (BaP) PAH Deposition Network
    await DownloadYourDataPage.getDownloadPAHDepositionNetworkMonitoringNetworkButton.click()
    ...
    await browser.waitUntil(
      ...
      },
      {
        timeout: 240000,
        interval: 500,
        timeoutMsg: 'PAH Deposition Network download not detected within 240s'
      }
    )
    ...
    for (const csvPath of csvPaths) {
      ...
      if (
        pollutantValues.some((value) =>
          value.toLowerCase().includes('benzo(a)pyrene')
        )
      ) {
        hasExpectedPollutant = true
      }
  ...
  it('AQD-1516 - tab content for PAH Digitel (solid+vapour) Network', async () => {
    await browser.url('')
    await browser.maximizeWindow()
    await startNowPage.startNowBtnClick()
    await hubPage.getCreateCustomDataSet.click()
...
(Visual only)`
  ...
  it('AQD-1516 - download checks for PAH Digitel (solid+vapour)', async () => {
    await browser.url('')
    await browser.maximizeWindow()
    await startNowPage.startNowBtnClick()
    await hubPage.getCreateCustomDataSet.click()
    ...
    // Download : PAH solid + vapour data
    await DownloadYourDataPage.getDownloadPAHSolidAndVapourNetworkMonitoringNetworkButton.click()
  ...
  it('AQD-1516 - download checks for PAH Digitel (solid phase)', async () => {
    ...
    for (const csvPath of csvPaths) {
      ...
      if (
        pollutantValues.some((value) =>
          expectedPollutants.some((pollutant) =>
            value.toLowerCase().includes(pollutant)
          )
        )
      ) {
        hasExpectedPollutant = true
